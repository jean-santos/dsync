...
impl<'a> TableOptions<'a> {
    pub fn default() -> Self {
        Self {
            ignore: None,
            autogenerated_columns: None,
            tsync: None
        }
    }

    pub fn get_ignore(&self) -> bool { self.ignore.unwrap_or_default() }
    pub fn get_tsync(&self) -> bool { self.tsync.unwrap_or_default() }
    pub fn get_autogenerated_columns(&self) -> Vec<&'_ str> { self.autogenerated_columns.clone().unwrap_or_default() }
    ...
    pub fn apply_defaults(&self, other: &TableOptions<'a>) -> Self {
        Self {
            ...
            autogenerated_columns: self.autogenerated_columns.clone().or(other.autogenerated_columns.clone())
        }
    }
}
...
impl<'a> GenerationConfig<'_> {
    pub fn table(&self, name: &str) -> TableOptions<'_> {
        let t = self.table_options.get(name).unwrap_or(&self.default_table_options);
